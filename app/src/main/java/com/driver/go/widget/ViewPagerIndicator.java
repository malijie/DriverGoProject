...
public class ViewPagerIndicator extends LinearLayout {
	...
	private static final int COLOR_TEXT_NORMAL = Util.getColor(R.color.font_black);
	private static final int COLOR_TEXT_HIGHLIGHT = Util.getColor(R.color.font_black);
	...
	public ViewPagerIndicator(Context context, AttributeSet attrs) {
		...
		mPaint.setColor(Util.getColor(R.color.app_green_normal));
...
//		mTriangleWidth = Math.min(mTriangleWidth, DIMENSION_TRIANGLE_WIDTH_MAX);
	...
	private void initTriangle() {
		...
		mPath.lineTo(mTriangleWidth,-10);
		mPath.lineTo(0,-10);
